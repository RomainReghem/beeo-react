...
const Calques = ({setDisplayZonesBio, setDisplayFermesBio, setDisplayRivieres}) => {
    return (
        <Stack gap={2}>
            <Stack>
                <Stack direction='row' align={'center'}>
                    <Switch onChange={(e) => {setDisplayZonesBio(e.target.checked)}} colorScheme='bee' />
            ...
            <Stack>
                <Stack direction='row' align={'center'}>
                    <Switch onChange={(e) => {setDisplayFermesBio(e.target.checked)}} colorScheme='bee' />
            ...
            <Stack>
                <Stack direction='row' align={'center'}>
                    <Switch onChange={(e) => {setDisplayRivieres(e.target.checked)}} colorScheme='bee' />
                    <Text>Rivières</Text>
                </Stack>
