...
const Home = () => {
    ...
    return (
        <Center flexDirection={'column'} p={4} minH={'100%'} bgImage={'url(https://www.wallpaperup.com/uploads/wallpapers/2013/02/14/40146/a0594c187bca3b801c2f108e2741967a.jpg)'}>
            <Stack maxW={'xl'}>
            ...
            <Stack align={'start'} boxShadow={'rgba(0, 0, 0, 0.16) 0px 3px 6px, rgba(0, 0, 0, 0.23) 0px 3px 6px;'} p={'8'} bg={'#F7FFE0'} >
                ...
                <Heading fontSize={'xl'}>Mise à jour x.x</Heading>
            ...
            <Stack align={'start'} boxShadow={'rgba(0, 0, 0, 0.16) 0px 3px 6px, rgba(0, 0, 0, 0.23) 0px 3px 6px;'} p={'8'} bg={'#F7FFE0'} >
                ...
                <Button onClick={() => navigate('/questionnaire')} colorScheme={'bee'}>Répondre</Button>
            </Stack>
            </Stack>
        </Center>
